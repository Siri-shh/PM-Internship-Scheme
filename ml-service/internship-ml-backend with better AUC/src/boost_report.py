...
def build_student_boost_report(boosted_df, final_alloc_df, out_path):
    ...
    # Summarize boost at student-level
    student_boost = (
        boosted_pairs
        .groupby("student_id")
        .agg(
    ...
    boosted_selected_students = boosted_selected_students.copy()
    ...
    # Summary Statistics
    # -----------------------
    if total_boosted_students == 0:
        avg_student_boost = 0.0
        max_student_boost = 0.0
        coverage_ratio = 0.0
    else:
    ...
    report = {
        ...
        ) if total_boosted_students else 0.0,
        ...
        "counterfactual_help_rate_among_boosted":
            round(helped_count / total_boosted_students, 4)
            if total_boosted_students else 0.0,
